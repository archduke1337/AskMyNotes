...
import { LogOut, User, Mail, Shield, Loader2, Lock } from "lucide-react";
  ...
  return (
    <div className="flex flex-col h-full bg-bg-app relative">
      ...
      <div className="h-12 border-b border-border-strong flex items-center px-4 md:px-6 shrink-0 bg-bg-surface relative z-10">
        <h2 className="text-sm font-mono tracking-widest uppercase font-bold">SYSTEM CONFIGURATION</h2>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-8 relative z-10 max-w-2xl mx-auto w-full space-y-6">
        ...
        <div className="border border-border-strong bg-bg-surface">
          <div className="border-b border-border-strong p-4 bg-text-primary text-bg-app">
            <h3 className="text-sm font-mono font-bold tracking-widest uppercase">OPERATOR PROFILE</h3>
          </div>
          <div className="p-4 md:p-6 space-y-4">
            <div className="flex items-center gap-4 border border-border-strong p-4">
              <div className="w-12 h-12 bg-text-primary text-bg-app flex items-center justify-center font-mono text-base font-bold shrink-0">
            ...
            <div className="flex items-center gap-2 border border-border-strong p-3 bg-bg-subtle">
              ...
              <span className="text-sm font-mono tracking-widest uppercase text-text-tertiary">
                ID: {user?.$id || "—"}
              </span>
            </div>
          </div>
        ...
        <div className="border border-border-strong bg-bg-surface">
          <div className="border-b border-border-strong p-4 bg-bg-subtle">
            <h3 className="text-sm font-mono font-bold tracking-widest uppercase">SECURITY</h3>
          </div>
          <div className="p-4 md:p-6 flex flex-col gap-3">
            <button
              // Action to change password (could tie to an Appwrite API)
              onClick={() => alert("Change password flow active")}
              className="w-full inline-flex items-center justify-center gap-2 px-6 py-4 border border-border-strong text-text-primary font-mono text-sm tracking-widest uppercase font-bold cursor-pointer transition-colors hover:bg-bg-subtle"
            >
        ...
        <div className="border border-danger/30 bg-bg-surface">
          <div className="border-b border-danger/30 p-4 bg-danger/5">
            <h3 className="text-sm font-mono font-bold tracking-widest uppercase text-danger">DANGER ZONE</h3>
          </div>
          <div className="p-4 md:p-6">
            <button
              onClick={handleLogout}
              className="w-full flex items-center justify-center gap-2 py-3 border border-danger text-danger font-mono text-sm tracking-widest uppercase font-bold hover:bg-danger hover:text-white cursor-pointer transition-colors"
            >
        ...
        <div className="border border-border-subtle bg-bg-surface p-4 text-center">
          <p className="text-sm font-mono text-text-tertiary tracking-widest uppercase">
