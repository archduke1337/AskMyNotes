...
export default function Sidebar({ onClose }: SidebarProps) {
  ...
  useGSAP(
    () => {
      // Subtle staggered load for terminal directories on initial boot
      gsap.fromTo(
        ".gsap-nav-item",
        { opacity: 0, x: -5 },
        {
          ...
          stagger: 0.05,
          ease: "power2.out",
          delay: 0.1, // Slight delay to wait for AppShell layout paint
        }
      );
    },
    { scope: containerRef }
  ...
  return (
    <aside ref={containerRef} className="w-56 border-r border-border-strong bg-bg-surface flex flex-col shrink-0 h-full">
      {/* Brand Header */}
      ...
      <nav className="flex-1 flex flex-col overflow-y-auto">
        <div className="text-base font-mono tracking-widest text-text-tertiary px-4 pt-6 pb-2 uppercase border-b border-border-strong">
          Primary Indices
        </div>
        ...
        <div className="mt-auto">
          <div className="text-base font-mono tracking-widest text-text-tertiary px-4 pt-4 pb-2 uppercase border-t border-b border-border-strong">
            System
          </div>
          <Link
            href="/settings"
      ...
      <div className="p-4 border-t border-border-strong">
        <div className="text-base font-mono leading-tight text-center text-text-tertiary uppercase">
